...
public final class BytecodeScanner {
    ...
    public record Reference(String sourceMethod,String kind,String owner,String name,String descriptor,int opcode,Boolean ownerInterface) {
        public Reference(String sourceMethod,String kind,String owner,String name,String descriptor,int opcode){this(sourceMethod,kind,owner,name,descriptor,opcode,opcode==Opcodes.INVOKEINTERFACE?Boolean.TRUE:opcode==Opcodes.INVOKEVIRTUAL?Boolean.FALSE:null);}
        ...
        ClassVisitor visitor=new ClassVisitor(Opcodes.ASM9){
            ...
            @Override public MethodVisitor visitMethod(int access,String name,String descriptor,String signature,String[] exceptions){
                ...
                return new MethodVisitor(Opcodes.ASM9){
                    @Override public void visitMethodInsn(int opcode,String owner,String method,String desc,boolean isInterface){add(new Reference(source,"METHOD",owner,method,desc,opcode,isInterface));type(source,Type.getMethodType(desc));}
