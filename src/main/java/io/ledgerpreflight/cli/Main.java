...
public final class Main implements Callable<Integer> {
    ...
    static Path createSupportPackage(Path output,Map<String,String> files)throws IOException {
        Path zip=output.toAbsolutePath().normalize(),checksum=zip.resolveSibling(zip.getFileName()+".sha256");
