...
public final class SupportBundle {
    ...
    private static final Set<String> ALLOWED=Set.of("README.txt","summary.txt","summary.html","assessment.json",
        ...
        "required-symbol-resolution.json","current-runtime-selection.json","tvu-evidence-supplied.json","tvu-summary.json","findings.json","reproduction.txt","sanitized-node.conf");
