...
public final class SupportBundle {
    ...
    private static final Set<String> ALLOWED=Set.of("README.txt","summary.txt","summary.html","assessment.json",
        ...
        "execution-contexts.json","required-symbol-resolution.json","current-runtime-selection.json","tvu-evidence-supplied.json","tvu-summary.json","tvu-schema-execution.json","findings.json","reproduction.txt","sanitized-node.conf");
