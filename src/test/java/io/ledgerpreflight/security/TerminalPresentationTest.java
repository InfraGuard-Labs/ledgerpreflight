...
class TerminalPresentationTest {
    ...
    @Test void realReplayCliDefaultFitsOneScreenAndKeepsEvidenceInReport() throws Exception {
        ...
        assertTrue(output.contains("Node: current-node")); assertTrue(output.contains("4.11.9 → 4.12.11"));
        assertTrue(output.contains("✕ BLOCKED")); assertTrue(output.contains("! WARNING")); assertTrue(output.contains("✓ PASS"));
        assertTrue(output.contains("WHAT STOPS THIS UPGRADE")); assertTrue(output.contains("NEXT")); assertTrue(output.contains("Full details:"));
        assertTrue(output.contains("additional findings are available in the full report."));
    ...
    @Test void hundredsOfFindingsRemainShortAndEverySummaryLineFitsNarrowTerminal() {
        ...
        assertTrue(output.contains("297 additional findings are available in the full report."));
