...
class EndToEndTest {
    ...
    @Test void realCliProducesOfflineHtmlJsonAndSanitizedBundle()throws Exception {
        ...
        int code=cli.execute("assess","--node",fixture.node().toString(),"--upgrade-kit",fixture.kit().toString(),"--tvu-results",fixture.log().toString(),"--tvu-results",fixture.errors().toString(),"--verifier-classpath",fixture.classpath().toString(),"--output",output.toString(),"--offline","--support-bundle");assertEquals(2,code,stderr.toString());assertTrue(stdout.toString().contains("NOT READY TO UPGRADE"));
